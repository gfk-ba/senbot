Feature: Name spacing test runs to prevent interference with other tests
  ...
  Scenario: Namespace form and table test
   ...
   Scenario: Scenario Namespace form and table test
    Given I am on webpage "resource_location:/test_pages/namespaceTest.html"
     When I fill the field "id:textField" with "SNS:My nice value"
      And I click the "Button" button
     Then table cell "id:cell_2_1" should have a scenario namespaced value "My nice value"
      And the table "id:exampleTable" should contain the columns
     	| Table header 1   |
     	| Table cell 1     |
     	| SNS:My nice value |
   ...
   Scenario: Scenario Namespace test follow up
     Then table cell "id:cell_2_1" should not match "SNS:My nice value"
